...
public class Kerstpuzzel2020Nr11C {

	public static void main(String[] args) {
		Kerstpuzzel2020Nr11C kerstpuzzel2020Nr11 = new Kerstpuzzel2020Nr11C();
	...
	private void run() {
		...
		for(int letter1 = 65; letter1 < 91; letter1++) {
			for(int letter2 = 68; letter2 < 91; letter2++) {
				for(int letter3 = 72; letter3 < 91; letter3++) {
					for(int letter4 = 78; letter4 < 91; letter4++) {
