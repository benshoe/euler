...
public class EulerRunner {
	...
	static {
		...
		m_problems.add(new Problem005("232792560"));
		...
		//m_problems.add(new Problem051("121313"));
		//m_problems.add(new Problem052("142857"));
		//m_problems.add(new Problem053("4075"));
		...
		//m_problems.add(new Problem059("107359"));
		//m_problems.add(new Problem060("1"));
	}
